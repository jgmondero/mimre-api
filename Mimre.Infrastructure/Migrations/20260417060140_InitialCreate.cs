        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Albums_Galleries_GalleryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DownloadPermission = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShareLinks_Galleries_GalleryId",
                        column: x => x.GalleryId,
                        principalTable: "Galleries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WatermarkedBlobPath = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DownloadLogs_ShareLinks_ShareLinkId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Albums_GalleryId",
                table: "Albums",
                column: "GalleryId");

            migrationBuilder.CreateIndex(
                name: "IX_DownloadLogs_ShareLinkId",
                table: "DownloadLogs",
                column: "ShareLinkId");

            migrationBuilder.CreateIndex(
                name: "IX_Galleries_UserId_Slug",
                table: "Galleries",
